package ispd.fxgui.workload;

import ispd.Main;
import ispd.commons.StringConstants;
import ispd.fxgui.workload.dag.DAG;
import ispd.fxgui.workload.dag.DagEditor;
import ispd.gui.iconico.grade.DesenhoGrade;
import ispd.util.workload.DAGContainer;
...
public class GenerateWorkloadPane extends VBox {
    ...
    private void createContent() {
        ...
        addDagButton.setGraphic(new ImageView(new Image(Main.class.getResource(StringConstants.PLUS_ICON_PATH).toExternalForm())));
        editDagButton = new Button();
        editDagButton.setGraphic(new ImageView(new Image(Main.class.getResource(StringConstants.EDIT_ICON_PATH).toExternalForm())));
    ...
    public void setEntries(GenerateWorkloadEntry... entries) {
        List<GenerateWorkloadEntry> theList = new ArrayList<>();
