...
import ispd.fxgui.workload.WorkloadPane;
...
import ispd.util.workload.WorkloadConverter;
...
public class JPrincipal extends javax.swing.JFrame implements KeyListener {
    ...
    // JavaFX wrappers
    private javax.swing.JFrame workloadPaneFrame;
    private JFXPanel fxWorkloadPanel;
    private WorkloadPane workloadPane;

    public javax.swing.JFrame getWorkloadPaneFrame() {
    ...
    public JPrincipal() {
        ...
        // FX workload pane creation
        this.workloadPaneFrame = new javax.swing.JFrame("Workload Configuration");
        ...
        this.workloadPaneFrame.setSize(500, 400);
        Platform.runLater(() -> {
                ...
                if (file.getName().endsWith(".ims") || file.getName().endsWith(".imsx")) {
                    try {
                        if (file.getName().endsWith(".imsx")) {
                            ...
                            // Platform RUN LATER is needed once JavaFX thread may not
                            // be initialized yet
                            Platform.runLater(() -> {
                                workloadPane = new WorkloadPane();
                                workloadPane.setjPrincipal(this);
